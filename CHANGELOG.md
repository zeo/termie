...
- **Pane mode looks draggable.** Entering it outlines every pane, attaches a four-tick grab plate to each top edge, brightens the focused pane, and puts the drag and escape hint in the status bar. The grab cursor and docking preview take over once the pointer moves.
